...
public class UserDailyTrendResponse {
    private String date;
    private long total;
    ...
    public UserDailyTrendResponse(String date, long total, long accepted, double acRate, double avgTimeMs, double avgMemoryKb) {
        this.date = date;
        this.total = total;
