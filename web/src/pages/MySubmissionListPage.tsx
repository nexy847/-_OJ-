...
import { getMySubmissionDetail, getMySubmissions } from '../api/submissions'
...
export function MySubmissionListPage() {
  ...
  const detailQuery = useQuery({
    queryKey: ['my-submission-detail', selectedId],
    queryFn: () => getMySubmissionDetail(selectedId!),
        ...
        <div className="page-toolbar">
          <div>
            ...
            <Typography.Paragraph type="secondary" style={{ marginBottom: 0 }}>
              Review your full submission history and inspect judge details, including source code.
        ...
        {detailQuery.isLoading ? (
          ...
          <Space direction="vertical" size={16} style={{ display: 'flex' }}>
            <Descriptions bordered column={2}>
              ...
              <Descriptions.Item label="Model Message" span={2}>
                {detail.message ?? '-'}
              </Descriptions.Item>
            </Descriptions>
